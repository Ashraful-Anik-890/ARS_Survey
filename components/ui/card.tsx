...
const Card = React.forwardRef<
    HTMLDivElement,
    React.HTMLAttributes<HTMLDivElement> & { variant?: "glass" | "glass-dark" | "default" }
>(({ className, variant = "glass", ...props }, ref) => (
    <div
        ref={ref}
        className={cn(
            "rounded-xl border shadow-sm transition-all duration-300",
            variant === "glass" && "glass-card hover:-translate-y-1 hover:shadow-xl hover:shadow-primary/10",
